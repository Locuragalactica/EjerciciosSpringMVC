...
public class NoticiaController {
    ...
    public String registro(@RequestParam String titulo, @RequestParam String cuerpo, ModelMap modelo) {
        ...
        try {
            ...
            modelo.addAttribute("exito", "La Noticia fue cargada correctamente!");
    ...
    public String eliminar(@PathVariable String id, ModelMap modelo) throws MiException {
        ...
        try {
            ...
            modelo.addAttribute("exito", "La Noticia fue borrada correctamente!");
    ...
    public String mostrar(@PathVariable String id, ModelMap modelo) throws MiException {
